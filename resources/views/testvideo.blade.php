...
<div class="row">
    <div class="session-playlist col-md-3 px-0 collapsed d-sm-none">
        ...
        <ul class="timeline">
            ...
            <li class="row py-2">
                <a class="col-md-8 title text-gold" href="#"> {{ $video->title }} </a>
                <span class="col-md-4 duration text-right px-0"> {{ $video->duration() }} </span>
    ...
    <div class="poster col-md px-0">
        <div class="session-poster w-100" style="height:600px;">
            ...
            <div class="session-title-overlay p-4">
                <h3 class="text-gold mb-1">Session title goes here</h3>
                <small class="text-white">{{$course->name}} | {{ $course->level->name }} | {{ $course->school }} | {{ $course->system ?? '' }} | {{ $course->sub_system ?? '' }} | 45 mins</small>
            </div>
        </div>
    </div>
