...
<div class="wrapper h-100">
  <div class="m-auto h-100">
    <div class="h-100">
      <img src="/res/person.png" alt="" class="img-responsive float-right mt-5" style="height:90%;width:33%" data-toggle="tooltip"
        data-placement="left" title="Welcome to A-star academy. I'm Lisa, I'll be your guide.">
