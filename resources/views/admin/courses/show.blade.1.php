                    ...
                    <form action="{{ $course->videosRoute('store') }}" id="form" method="POST" class="ajax" enctype="multipart/form-data">
                        ...
                        <div class="body">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <span class=""> Select overview session </span>
                                <input type="file" name="video" accept="video/*"> </span>
...
@push('css')
    <link rel="stylesheet" href="{{ secure_asset('assets/plugins/waitMe/waitMe.css') }}" />
    <link rel="stylesheet" href="{{ secure_asset('assets/plugins/bootstrap-fileinput/bootstrap-fileinput.css') }}" />
@endpush

@push('scripts')
    <script src="{{ secure_asset('assets/plugins/bootstrap-fileinput/bootstrap-fileinput.js') }}"></script>
    ...
    <script src="{{ secure_asset('js/admin/courses/show.js') }}"></script>
@endpush