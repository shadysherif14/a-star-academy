    ...
    @include('admin.partials.file-image', ['inputName' => 'image'])
        ...
        <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <textarea type="text" name="description" id="description" class="form-control" placeholder="Course Description">{{ $course->description }}</textarea>
            </div>
            ...
            <div parent="system" id="system" class="form-group hidden">
                ...
                <div class="radio">
                    ...
                    <label for="radio-{{ $system }}"> {{ $system }} </label> @endforeach
                </div>
            </div>
            ...
            <div parent="sub_system" id="sub_system" class="form-group hidden">
                ...
                <div class="radio">
                    ...
                    <label for="radio-{{ $subsystem }}" class="mr-3"> {{ $subsystem }} </label> @endforeach
                </div>
            </div>
        </div>
...
<script src="{{ asset_path('js/admin/courses/create-edit.js') }}"></script>
